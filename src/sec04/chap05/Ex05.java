...
public class Ex05 {
    public static void main(String[] args) {
        ...
        String[] teachers = {"황선생", "박선생", "김선생"};
        String class3T3SDescByArr = descClassManyTeacher(3, teachers, "짱구", "철수", "훈이");
    }
    ...
    static String descClassManyTeacher (int classNo, String[] teachers, String... kids) {
        return "%d반의 담당은 %s 선생님, 원생들은 %s 입니다."
                .formatted(classNo, String.join(", ", teachers), String.join(", ", kids));
    }
